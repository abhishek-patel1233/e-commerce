...
.orders-container{max-width:1100px;margin:40px auto;}
.orders-card{background:white;border-radius:10px;padding:25px;box-shadow:0 5px 15px rgba(0,0,0,0.08);}
.orders-title{font-weight:600;margin-bottom:20px;}
